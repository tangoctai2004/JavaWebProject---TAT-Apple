...
public class DeleteProductServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        try {
            ...
            // Chuyển hướng về trang admin-products.jsp
            if (deleted) {
                response.sendRedirect("admin-products.jsp?deleteSuccess=true");
            } else {
                response.sendRedirect("admin-products.jsp?deleteSuccess=false");
            }
