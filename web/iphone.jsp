            ...
            <div class="all-product-list">
                <div class="all-product-frame">
                    <div class="all-product">
                        <a href="product.jsp">
                            <img class="all-product-img" src="images/iPhone/iPhone16 series/iPhone 16/Teal/teal-16.jpeg">
                        </a>
                        <p class="all-product-name">iPhone 16</p>
                        <p class="all-product-price">21,490,000 <u>đ</u></p>
                        <div class="all-product-color">
                            <span>
                                <img class ="all-product-color_icon" src="images/iPhone/iPhone16 series/iPhone 16 Plus/Black/black-color.png"/>
                            </span>
                            <span>
                                <img class ="all-product-color_icon" src="images/iPhone/iPhone16 series/iPhone 16 Plus/White/white-color.png"/>
                            </span>
                            <span>
                                <img class ="all-product-color_icon" src="images/iPhone/iPhone16 series/iPhone 16 Plus/Ultramarine/ultramarine-color.png"/>
                            </span>
                            <span>
                                <img class ="all-product-color_icon" src="images/iPhone/iPhone16 series/iPhone 16 Plus/Teal/teal-color.png"/>
                            </span>
                            <span>
                                <img class ="all-product-color_icon" src="images/iPhone/iPhone16 series/iPhone 16 Plus/Pink/pink-color.png"/>
                            </span>
                        </div>
                    </div>
                </div>
